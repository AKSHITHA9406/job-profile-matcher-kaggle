...
## 5. Using Local PDF/DOCX Resumes Instead

If you also want to match **your own resumes (PDF/DOCX)**:

1. Put them in a folder, e.g.:

```text
/Users/you/Downloads/resumes/
```
...
cd backend
python3 cli.py \
  --job "/Users/you/Downloads/sample_job_description.pdf" \
  --resumes "/Users/you/Downloads/resumes" \
  --topn 10
```

---

## 6. Start the FastAPI Backend (for future frontend / Postman)
...
Use the `/match` endpoint for **single-job + multiple resumes upload**.
